...
ggplot(
  ...
  labs(
    title = "Inflation-Adjusted Wealth Growth of U.S. Presidents",
    subtitle = "Percentage change in net worth during time in office",
    x = NULL,
    y = "Real Wealth Growth (%)",
    fill = "Party",
    caption = "*Second-term figures are projections, not final estimates."
  ) +
