...
period = c("Civl War","Baby Boom", "Oil Crisis / Recession", "Great Recession", "COVID-19 Pandemic")
bands <- data.frame(
  start = c(1861, 1946, 1973, 2007, 2020),
  end   = c(1865, 1964, 1975, 2009, 2023),
  period = factor(period, levels = period),
  color = c("#838383","#85C9E8", "#F6762A", "#630031", "#171717"))
